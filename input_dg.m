...
n_cell = [25];  %# of cells along one dimension (make odd for line, multiples of 26 < 208 for hohlraum, multiples of 28 <  224 for lattice)
n_mus = [ 4];   %# of ordinates, should be even and >4
