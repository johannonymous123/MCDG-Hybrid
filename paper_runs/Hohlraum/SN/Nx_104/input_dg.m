...
mode = 'hohlraum';   %Chose test problem. Options: hohlraum, hohlraum,lattice
% Following inputs can be list and all combinations  of them will be used.
n_cell = [104];  %# of cells along one dimension (make odd for hohlraum, multiples of 26 < 208 for hohlraum, multiples of 28 <  224 for lattice)
